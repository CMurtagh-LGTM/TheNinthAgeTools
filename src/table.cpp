...
//   auto div = dom::append_div_child(node_parent);
//   auto accordion = dom::append_accordion_child(div);

//   add_unit_header(book_entry, *accordion.button, name);
//   add_table(unit, rules, book_entry, *accordion.div);
